...
function NavBar() {
  ...
  return (
    <nav className="hidden md:flex justify-between items-center gap-1">
      ...
      {user
        ? <Link to="/airbnb-clone/account" className="flex gap-1 justify-between items-center cursor-pointer p-2 rounded-3xl border-2 border-gray-400/30 hover:shadow-md hover:shadow-gray-200 relative">
