...
function NavBar() {
  return (
    <nav className="flex justify-between items-center gap-1">
      ...
      <div className="flex gap-1 justify-between items-center cursor-pointer p-2 rounded-3xl border-2 border-gray-400/30 hover:shadow-md hover:shadow-gray-200">
